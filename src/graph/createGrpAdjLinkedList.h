#ifndef CREATE_GRP_ADJ_LINKED_LIST_H
#define CREATE_GRP_ADJ_LINKED_LIST_H
...
//***************************自定义类与宏定义补充********************//
#ifndef GRAPH_COMMON_DEFINED
#define GRAPH_COMMON_DEFINED
...
inline void strLTrim(char* str);  //删除字符串左边空格
...
//* 出口参数：Graph &G，即创建的图                                  *//
//* 返 回 值：bool，true创建成功；false创建失败                     *//
//* 函数 名：CreateGraphUDFromFile(char fileName[], Graph &G)      *//
